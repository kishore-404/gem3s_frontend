    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <button 
          ...
          className="bg-[#126b8a] hover:bg-[#0e566f] text-white text-[16px] font-medium py-2 px-12 rounded-full transition-transform hover:scale-105 duration-300 shadow-sm"
        >
          Book
        </button>
      </div>
