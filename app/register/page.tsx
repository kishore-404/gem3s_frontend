      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-[480px] border border-gray-300 rounded-[32px] px-8 py-10 bg-white">
          ...
          <div className="text-center mb-8">
            <h1 className="text-[32px] font-serif text-gray-900 tracking-tight mb-1">
              Let's get started!
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 px-4">
            ...
            <div>
              <input
                ...
                required
                className="w-full px-6 py-3.5 rounded-full border border-gray-300 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition-colors shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]"
              />
            </div>
